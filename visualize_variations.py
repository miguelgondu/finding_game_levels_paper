"""
This script prints variations of levels (for visualizing only)
"""
import numpy as np
...
for level_id in range(10):
    ...
    save_level_from_array(
        level, f"./zelda_experiments/variations_viz/level_{level_id}_original.jpg"
    )
    for var_id in range(10):
        ...
        save_level_from_array(
            level,
            f"./zelda_experiments/variations_viz/level_{level_id}_var_{var_id+1}.jpg",
        )
