...
from process_generations import compute_winrate_performance, plot_winrate, plot_performance
...
def process(folder_name, feat_1, feat_2, max_iterations):
    ...
    for i, update_path in enumerate(updates):
        ...
        try:
            ...
            plt.savefig(update_path.replace(".json", f"_mean_performance_{feat_1}_{feat_2}.jpg"))
            plt.close()
